...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.generateRibbonGeometryClass = factory());
	        ...
	        constructor(path, ribbonSegments = 64, ribbonWidth = 1, numOfTwist = 0, twistEasing = linear, closed = false) {
	            ...
	            function generateSegment(i) {
	                ...
	                for (let j = 0; j <= radialSegments; j++) {
	                    ...
	                    vertex.y = P.x + ribbonWidthHalf * (cos * normal.x + sin * binormal.x);
	                    vertex.x = P.y + ribbonWidthHalf * (cos * normal.y + sin * binormal.y);
	            ...
	            function generateUVs() {
	                for (let i = 0; i <= ribbonSegments; i++) {
	                    for (let j = 0; j <= radialSegments; j++) {
	                        uv.y = 1 - j / (radialSegments - 1);
	                        uv.x = i / ribbonSegments;
	                        uvs.push(uv.x, uv.y);
	                    }
	                }
	            }
	...
	return generateRibbonGeometryClass;
